...
BEGIN 
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can read own credit cards'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'credit_cards' 
    AND policyname = 'Users can insert own credit cards'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'credit_cards' 
    AND policyname = 'Users can update own credit cards'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'credit_cards' 
    AND policyname = 'Users can delete own credit cards'
  ) THEN
